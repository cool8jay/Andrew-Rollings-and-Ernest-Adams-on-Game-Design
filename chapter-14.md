...
经济是一个生产、消费和交换资源的系统。在许多 CMS 中，主要资源是货币。资源的特性会影响游戏的方式。例如，资源可以是有形的，需要储存空间，必须建造并支付费用；也可以是无形的，不占用物理空间，从一个地方移动到另一个地方不需要花费任何费用。金钱通常被视为无形资源，但食物和建筑材料通常被视为有形实体。偶尔也有例外：《地牢守护者》（另一款混合型游戏）将黄金视为有形资源，必须开采并运回金库，当金库满了之后，玩家必须扩充金库。
...
许多游戏以混合的方式处理资源，有时是有形的，有时是无形的。《地牢守护者》和《帝国时代》都要求将资源从生产点运送到储存设施；在此期间，资源很容易被敌人破坏或夺取。然而，在《帝国时代》中，当资源被储存起来后，即使敌人拆毁了储存坑，也无法夺取或毁坏它。实际上，当资源被储存起来时，它们就变得无形了。
...
同样，大多数 CMS 都不需要通过实际运输来消耗资源，它只需从仓库中消失即可。在《帝国时代》中建造建筑时，玩家不需要把石头从储藏坑运到建筑工地。这为玩家减轻了额外的管理负担。
