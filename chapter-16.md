...
人造宠物是人造生命游戏的一个子类别。人造宠物是生活在电脑上的仿真动物，它们可以生活在自己的环境中，也可以生活在电脑桌面上。它们可以是真实动物的模拟（如 PF.Magic 开发的 [《宠物》](https://en.wikipedia.org/wiki/Petz) 系列），也可以是幻想出来的动物，比如拓麻歌子，一种内置在钥匙链中的非常简单的小型电脑游戏。
