...
冒险游戏曾经是游戏市场上一个流行且利润丰厚的领域。随着时间的推移，解析器的复杂性使游戏中可使用的句子的性质得到了改善，而随着目标机器能力的不断提高，写作质量也相应提高。Infocom 公司（原 Zork 系列游戏的发行商）的《银河系漫游指南》（The Hitchhiker's Guide to the Galaxy）和 Magnetic Scrolls 公司的《鱼！》（Fish! 对于好奇者来说，可以在 Douglasadams.com (www.douglasadams.com/creations/infocomjava.html) 上玩 Java 版本的《搭车指南》。
